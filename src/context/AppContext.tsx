...
const mockSkills: Skill[] = [
  { id: "1", title: "Public Speaking", category: "Leadership", description: "Won inter-college debate competition 2024", proof: "Certificate from XYZ University", status: "verified", studentId: "s1", studentName: "Aarav Sharma", submittedAt: "2024-11-15" },
  ...
  { id: "6", title: "Community Service", category: "Social", description: "Led rural education initiative for 200 students", proof: "NGO certification letter", status: "pending", studentId: "s3", studentName: "Rohan Mehta", submittedAt: "2025-02-01" },
